            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" class="w-full text-black bg-color">Sign up</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Register already <Link to='/login' class="font-medium text-primary-600 hover:underline dark:text-primary-500" style={{color: 'blue'}}>Login in</Link>
                        </p>
                    </form>
                </div>
            </div>
